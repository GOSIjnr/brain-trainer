...
public partial class Page2 : WelcomeContentPage
{
	...
	{
		_page2Player = GetNodeOrNull<Page2Player>("%Page2Player");
		_page2Controller = GetNodeOrNull<Page2Controller>("%Page2Controller");
