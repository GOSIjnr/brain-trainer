...
public partial class Toast : CanvasLayer
{
	...
	public async Task HideToastMessage()
	{
	...
	public async Task AnimateToast(float currentValue, float newValue, float duration)
	{
		...
		tween.TweenProperty(_toastPanel, modulateNodePath, new Color(1, 1, 1, newValue), duration);
